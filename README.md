...
1. Check to see if a new folder needs to be created or not.
  ...
  a. If there are no new folders, a new folder will need to be created. Create a base copy of the latest default.
      ...
      * Copy the folder and commit the change as `Base copy of folder X`
  b. If there is a new folder in the **dev** branch, use the existing folder.
